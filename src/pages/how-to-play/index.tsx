    ...
    <Container>
      ...
      <Section gap="m">
        ...
        <NormalTypography variant="m">
          För att kunna tippa matcher måste du först
          {' '}
          <InlineLink href={`/${RoutesEnum.LOGIN}`}>skapa ett konto</InlineLink>
          . Därefter kan du antingen skapa en liga eller gå med i en existerande liga genom att ange den inbjudningskod du fått av ligans skapare. Du kan vara med i flera ligor samtidigt.
        </NormalTypography>
        <NormalTypography variant="m">
          Glöm inte att läsa igenom
          {' '}
          <InlineLink href={`/${RoutesEnum.RULES}`}>reglerna</InlineLink>
          {' '}
          innan du börjar tippa.
        </NormalTypography>
      </Section>
      <Divider color={theme.colors.silver} />
      <Section gap="s">
        ...
        <NormalTypography variant="m">Varje omgång kan bestå av 1 till 24 matcher. Alla deltagare ska tippa resultat i varje match. I utvalda matcher kan man även tippa målskytt i matchen samt första lag att göra mål. Anledningen till att inte varje match kan ha tips för målskytt är att alla lag inte har spelare inlagda i systemet. En liga kan bestå av max 100 omgångar.</NormalTypography>
        ...
        <NormalTypography variant="m">Rättning av matcher samt skapande av omgångar sköts alltså manuellt av ligans skapare.</NormalTypography>
      </Section>
    </Container>
  </Page>
);
